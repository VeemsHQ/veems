...
class TestChannel:
    ...
    def test_banner_image(
        ...
        assert channel.banner_image_url
        assert channel.banner_image_url == channel.banner_image.url

    def test_banner_image_returns_default_when_not_set(
        self,
        channel_factory,
        user,
    ):
        ...
        assert channel.banner_image_url
        assert 'defaults/channel-banner-image.png' in channel.banner_image_url
