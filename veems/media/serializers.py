...
class VideoSerializer(CustomModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'default_thumbnail_image_medium_url',
            'default_thumbnail_image_large_url',
            'time_ago_human',
            'channel_name',
            'channel_id',
            'duration',
        ...
        extra_kwargs = {
            ...
            'default_thumbnail_image_medium_url': {'read_only': True},
            'default_thumbnail_image_large_url': {'read_only': True},
